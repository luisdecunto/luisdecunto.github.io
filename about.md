...
**Currently:** Research Assistant at **Aarhus University** (2021 - Present)
- Working on the **KurvedWind Project**: Developed FEM simulations of thermoforming processes and built ML-based surrogate models for spring-back prediction
- **Elasto Capillary Kirigami Project**: Mathematical modeling of geometrical metamaterials, conducting experiments, and analyzing complex material behavior

**Previously:**
- Research in **Mechanical Metamaterials and Soft Matter** (MMSM group) - Numerical simulations with ABAQUS, parallel computing with Python
- **Nuclear industry** experience at CONUAR FAE (Argentina) - FEM simulations of tube manufacturing processes
- **Teaching Assistant** - Mechanical Vibrations, Continuum Mechanics, Physics

**Education:**
- **M.Sc. in Mechanical Engineering** - Aarhus University (2019-2021)
  - Thesis: "Numerical Study of Stress Localization in Thin Shells"
- **Mechanical Engineer** - Instituto Tecnológico de Buenos Aires, ITBA (2011-2018)
...
I'm currently deepening my expertise in **Machine Learning** and **Data Science**, with a focus on applying ML to engineering problems. Check out my [projects](/projects/) to see some of my recent work, or read my [blog](/blog/) where I share insights on numerical methods, ML, and engineering.

### Let's Connect!

I'm always interested in collaborations, new opportunities, or discussions about:
